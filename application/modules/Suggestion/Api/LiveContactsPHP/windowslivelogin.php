 ...
 * @version    $Id: windowslivelogin.php (var) 2010-08-17 9:40:21Z SocialEngineAddOns $
...
class WindowsLiveLogin
{
    ...
    public static function initFromXml($settingsFile)
    {
        ...
        $settings['appid'] = '000000004804D925';
        $settings['secret'] = 'iTHpzDYRtZzppMT1iyw67h2NqdXhH8wK';
        $settings['securityalgorithm'] = 'wsignin1.0';
        $settings['returnurl'] = 'http://' . $_SERVER['HTTP_HOST'] . Zend_Controller_Front::getInstance()->getBaseUrl() . '/suggestion/usercontacts/getwindowlivecontacts';
        $settings['policyurl'] = 'http://www.hospitality.vn/statistics/index/privacy';
