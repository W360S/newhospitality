 ...
 * @version    $Id: request-photo.tpl (var) 2010-08-17 9:40:21Z SocialEngineAddOns $
...
<li class="suggestions-newupdate">
	...
	<div>
		<div>
			<?php echo $this->sender_name . $this->translate(" has sent you a profile photo suggestion") . '.'; ?>
		</div>	
		<div id="sugg_photo_<?php echo $this->photo_object->suggestion_id; ?>">
			...
			<span style="padding-top:5px;">
				or <?php	echo '<a class="disabled" title="' . $this->translate('Cancel this suggestion') . '" href="javascript:void(0);" onclick="cancelSuggphoto(\'' . $this->notification->notification_id . '\', \'' . $this->photo_object->suggestion_id . '\', \'' . $this->notification->object_id . '\');"> ' . $this->translate("ignore suggestion") . ' </a><br />'; ?>
			</span>
		</div>
	</div>
</li>
