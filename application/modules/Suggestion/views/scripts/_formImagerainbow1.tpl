 ...
 * @version    $Id: _formImagerainbow1.tpl (var) 2010-08-17 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
?>

<script src="application/modules/Suggestion/externals/scripts/mooRainbow.js" type="text/javascript"></script>
<?php 
...
echo '
	<div id="sugg_bg_color-wrapper" class="form-wrapper">
		...
		<div id="sugg_bg_color-element" class="form-element">
			...
			<input name="myRainbow1" id="myRainbow1" src="application/modules/Suggestion/externals/images/rainbow.png" link="true" type="image">
		</div>
	</div>
'
?>
