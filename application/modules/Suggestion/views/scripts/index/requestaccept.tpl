 ...
 * @version    $Id: reqestaccept.tpl (var) 2010-08-17 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
	...
	var action_session_id = "<?php echo $this->accept_friend_id;  ?>";
	var friend_id_str = '';
	...
	var action_module = 'requestaccept';
...
<div class="suggestion_popup">
	<?php
        $username= Engine_Api::_()->getItem('user', $this->accept_friend_id)->username;
        $base_url= $this->baseUrl(); 
        $friend_displayname = Engine_Api::_()->getItem('user', $this->accept_friend_id)->displayname;  ?>
			<h4><?php echo $this->translate("You are now friends with ") . "<a target='_parent' href='$base_url/profile/$username'>" . $friend_displayname . "</a>"; ?></h4>
			<p><?php echo $this->translate("You may also know some of ") . $friend_displayname . $this->translate("'s friends :"); ?></p>
	<div class="suggestion_member_search_box">
		<div class="requestaccept_members_search" style="float:left;">
      <input id="requestaccept_members_search_inputd" type="text" value="<?php echo $this->translate("Search Members"); ?>" onkeyup="show_searched_friends(0, event);">
    </div>
    <div class="link">
...
<?php } ?>
	...
	<form name="suggestion" method="POST" class="suggestion_form_popup" >
		<input type="hidden" name="friend" value="<?php echo $this->accept_friend_id;  ?>" />
		...
		<div id="new_requestaccept_show" class="suggestion_seleted_box"> </div>
		<?php if( $this->members->count() > 1 ): ?>
	    <div class="pagination">
	      <?php if( $this->members->getCurrentPageNumber() > 1 ): ?>
	        <div id="user_requestaccept_members_previous" class="paginator_previous" style="font-weight:bold;">
	      ...
	      <?php if( $this->members->getCurrentPageNumber() < $this->members->count() ): ?>
	        <div id="user_requestaccept_members_next" class="paginator_next" style="font-weight:bold;">
	  ...
	  <?php endif; ?>
		...
		<div id="check_error"></div>
			<button type='button' style="margin:10px 0 0 15px;" onClick='javascript:doCheckAll();'><?php echo $this->translate("Add Friends"); ?></button>
			&nbsp;
