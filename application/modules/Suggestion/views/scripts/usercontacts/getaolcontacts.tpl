 ...
 * @version    $Id: getaolcontacts.tpl (var) 2010-08-17 9:40:21Z SocialEngineAddOns $
...
if ($total > 0) { ?>
  <div class="header">	
			<div class="title">	
				<?php echo $this->translate("You have ");?> <?php echo $total .  $this->translate(" Aol contacts that you can add as your friends on ") .  Engine_Api::_()->getApi('settings', 'core')->getSetting('core.general.site.title') . "."; ?>
			</div>
			<div>
