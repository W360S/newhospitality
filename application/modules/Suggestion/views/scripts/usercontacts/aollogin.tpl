...
#sugg-aol-signin #signin-form button {
	background-image:url(../../application/modules/Suggestion/externals/images/aol-signin-btn.gif);
...
<div id="sugg-aol-signin">
	<div class="top">
		<?php $image_url = $this->baseUrl() . "/application/modules/Suggestion/externals/images/aol.png"; ?>
