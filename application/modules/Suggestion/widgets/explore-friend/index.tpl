...
// If error message is not set, which set when there are no suggestion available
if(!isset($this->empty_message))
{
	...
	<script type="text/javascript">
		...
		var explore_suggestion_display = "<?php echo count($this->mix_wid_dis_num); ?>";//Number of display suggestion.	
	...
	{	
		...
		{//Display group.
			case 'group':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								<div class="item_details">
									...
									echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->group_id . ', \'explore_'.$div_id.'\', \'group\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
			...
			case 'blog':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->blog_id . ', \'explore_'.$div_id.'\', \'blog\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
									<div class="item_members">
										<div>
			...
			case 'event':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								<div class="item_details">
									<?php if(empty($this->signup_user)) {
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->event_id . ', \'explore_'.$div_id.'\', \'event\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())) ?></b>
									<div class="item_members">
			...
			case 'album':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								<div class="item_details">
									<?php if(empty($this->signup_user)) {
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->album_id . ', \'explore_'.$div_id.'\', \'album\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0], $this->string()->chunk(substr($row_mix_value[0]->getTitle(), 0, 45), 10), array('title' => $row_mix_value[0]->getTitle())); ?></b>
									<div class="item_members">
			...
			case 'classified':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								<div class="item_details">
									<?php if(empty($this->signup_user)) {
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->classified_id . ', \'explore_'.$div_id.'\', \'classified\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
									<div class="item_members">
										<div>
			...
			case 'video':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								<div class="item_details">
									<?php if(empty($this->signup_user)) {
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->video_id . ', \'explore_'.$div_id.'\', \'video\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
									<div class="item_members">
										<?php echo $this->translate('by ') . $this->htmlLink($row_mix_value[0]->getOwner()->getHref(), $row_mix_value[0]->getOwner()->getTitle());
			...
			case 'music':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								<div class="item_details">
									<?php if(empty($this->signup_user)) {
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->playlist_id . ', \'explore_'.$div_id.'\', \'music\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
									<div class="item_members">
										<div>
			...
			case 'messagefriend':?>
					<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
						<div class="suggestion_list">
							...
							<div class="item_details">
								<?php echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->user_id . ', \'explore_'.$div_id.'\', \'messagefriend\', \'new\');"></a>';
									?>
							<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
								<div class="item_members">
									<?php
			...
			case 'friendfewfriend':?>
					<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
						<div class="suggestion_list">
								<?php echo $this->htmlLink($row_mix_value[0]->getHref(), $this->itemPhoto($row_mix_value[0], 'thumb.icon'), array('class' => 'item_photo')); ?>
							<div class="item_details">
									<?php echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->user_id . ', \'explore_'.$div_id.'\', \'friendfewfriend\', \'new\');"></a>';
									?>
								<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
								<div class="item_members">
			...
			case 'friendphoto':?>
					<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
						<div class="suggestion_list">
								<?php echo $this->htmlLink($row_mix_value[0]->getHref(), $this->itemPhoto($row_mix_value[0], 'thumb.icon'), array('class' => 'item_photo')); ?>
							<div class="item_details">
									<?php echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->user_id . ', \'explore_'.$div_id.'\', \'friendphoto\', \'new\');"></a>';
									?>
							<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
								<div class="item_members">
			...
			case 'friend':?>
				<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
					<div class="suggestion_list">
						<?php echo $this->htmlLink($row_mix_value[0]->getHref(), $this->itemPhoto($row_mix_value[0], 'thumb.icon'), array('class' => 'item_photo')); ?>
						<div class="item_details">
							<?php echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->user_id . ', \'explore_'.$div_id.'\', \'friend\', \'new\');"></a>';
							?>
							<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
			...
			case 'poll':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							<div class="suggestion_list">
								...
								<div class="item_details">
									<?php if(empty($this->signup_user)) {
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->poll_id . ', \'explore_'.$div_id.'\', \'poll\', \'new\');"></a>';
									} ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(), $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle())); ?></b>
									<div class="item_members">
			...
			case 'forum':?>
						<div id="explore_<?php echo $div_id; ?>" class="mix_suggestion_list_wrapper" style="float:<?php echo $this->cycle(array("left", "right")) ->next()?>">
							...
							<?php $photo_obj = Engine_Api::_()->getItem('user', $row_mix_value[0]->user_id); ?>
								...
								<div class="item_details">
									<?php if(empty($this->signup_user)) {
								echo	'<a style="margin-top:5px;" class="suggest_cancel" title="' . $this->translate('Do not show this suggestion') . '" href="javascript:void(0);" onclick="mixInfo(' . $row_mix_value[0]->topic_id . ', \'explore_'.$div_id.'\', \'forum\', \'new\');"></a>';
									} ?>
									<?php $forum_name =  Engine_Api::_()->getItem('forum_forum', $row_mix_value[0]->forum_id); ?>
									<b><?php	echo $this->htmlLink($row_mix_value[0]->getHref(),  $row_mix_value[0]->getTitle(), array('title' => $row_mix_value[0]->getTitle()));?></b>
									
									<div class="item_members">							
										<?php echo  $this->translate(' in ') . $this->htmlLink($forum_name->getHref(), $forum_name->getTitle(), array('title' => $forum_name->getTitle())); ?>
										<div>
...
?>
<style type="text/css">
.subsection ul li {padding-left: 28px;}
</style>