	    ...
	    <table style="clear:both;">
	    	<tr>
	    		...
	    		<td style="padding:3px;">
			      ...
			      <input name="label" id="label" value="<?php echo $this->stat_name ?>" class="text" type="text">
	    		</td>
	    	</tr>
	    	<tr valign="top">
	    		<td style="padding:3px;">
	    		...
	    		<td style="padding:3px;">
		    		<img id="myRainbow" src="application/modules/Feedback/externals/images/rainbow.png" alt="[r]" width="16" height="16" />&nbsp;&nbsp;
		    			<input id="myInput" name="myInput" type="text" value="<?php echo $this->stat_color ?>" size="13" /><br />
