...
class Activitypoints_AdminManageController extends Core_Controller_Action_Admin
{
  public function indexAction()
  {
    ...
    $rTable = $this->_helper->api()->getDbtable('points', 'activitypoints');
  ...
  public function transactionsAction()
  {
    ...
    if($task == "confirm") {
      ...
      $uptransaction = $this->_helper->api()->getDbtable('transactions', 'activitypoints')->complete($transaction_id);
    ...
    if($task == "cancel") {
      ...
      $uptransaction = $this->_helper->api()->getDbtable('transactions', 'activitypoints')->cancel($transaction_id);
    }
    ...
    $rTable = $this->_helper->api()->getDbtable('transactions', 'activitypoints');
    $rName = $rTable->info('name');
    $select = $table->select()
      ->setIntegrityCheck(false)
      ->from($rName)
