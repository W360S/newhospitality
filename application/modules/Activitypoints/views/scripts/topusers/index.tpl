...
<div style="font-weight: bold; font-size: 20px; width: 200px; padding-top: 10px"> <?php echo $this->translate('Our All Time Stars') ?> </div>
...
<div style="text-align:center; font-weight: bold"> <?php echo $this->translate('A guide to stardom') ?> </div>
<br>
<?php echo $this->translate('You can earn points by') ?>
<ol style="list-style: square; padding: 0px;margin-left: 20px; margin-bottom: 10px; margin-top: 10px">
<li> <a href="<?php echo $this->url(array('module'	=> 'albums', 'controller'	=> 'upload'),'default') ?>"> <?php echo $this->translate('Uploading photos') ?> </a>
<li> <?php echo $this->translate("Making comments (don't spam as you will get punished and have points deducted)") ?>
<li> <a href="<?php echo $this->url(array('module'	=> 'core', 'controller'	=> 'invite'),'default') ?>"> <?php echo $this->translate('Inviting your friends') ?> </a>
<li> <a href="<?php echo $this->url(array('module'	=> 'groups', 'controller'	=> 'create'),'default') ?>"><?php echo $this->translate('Creating groups') ?></a> <?php echo $this->translate("(spam control in effect)") ?>
<li> <?php echo $this->translate('(spam control in effect)') ?>

</ol>

<br>
  
<a href="<?php echo $this->url(array(), 'activitypoints_help') ?>"> <?php echo $this->translate('See more') ?> </a>
