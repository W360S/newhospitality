...
<tr><td class='setting2' colspan=2>
  ...
  <td valign="top"><input type='checkbox' name='set_points' id='set_points' value='1'<?php if ($this->set_points == 1): ?> checked='checked'<?php endif; ?>></td>
  <td><label for='send_message'><?php echo $this->translate('100016828') ?></label></td>
  </tr>
  </table>
  <br>
</td>
