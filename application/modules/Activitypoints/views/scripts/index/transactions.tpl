...
<h2><?php echo $this->translate("My Transaction history") ?></h2>

<p><?php echo $this->translate("This transaction history may not include points accrued by activities such as posting comments, creating groups, etc.") ?></p>
      ...
      <?php if( count($this->paginator) ): ?>
        <?php foreach( $this->paginator as $item ): ?>
          <tr>
            ...
            <td><?php echo $this->translate(Success + $item->uptransaction_state) ?></td>
