...
<div><?php echo $this->translate('This is a summary of your account. It includes the total points earned to date and current balance.') ?></div>
...
<div style="padding-left: 10px;">
  ...
  <div style="width: 300px; float: left; padding: 10px; padding-bottom: 40px; background-color: #f6f6f6;">
    <div style="padding-bottom: 12px">
      <strong style="color: #777"> <?php echo $this->translate('BALANCE') ?> </strong> <br>
    </div>
    ...
    <div style="font-size: 24px; color: #777 !important">
      <span id='userpoints_balance' style="font-weight: bold"><?php echo $this->user_points ?></span> <?php echo $this->translate('coupons') ?>
    </div>
    <br>
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function(){
    ...
    <div id="up_sendpoints_success" style="display:none;background-color: #F3FFF3; padding: 7px; font-weight: bold">
      <img src='application/modules/Activitypoints/externals/images/success.gif' style='float:left; margin-right: 5px' border='0'>
    ...
    <div id="up_sendpoints_fail" style="display:none; background-color: #FFEBE8; padding: 7px; font-weight: bold">
      <img src='application/modules/Activitypoints/externals/images/error.gif' style='float:left; margin-right: 5px' border='0'>
    ...
    <div id="up_sendpoints_main" style="display:block">
        ...
        <tr>
          ...
          <td class='activitypoints_browse_field'>
			...
			<div id="to-wrapper" Xclass="form-wrapper" <?php if( isset($this->toUser) && $this->toUser->getIdentity() ): ?>style="display:none;"<?php endif; ?>>
			  <div id="to-element" Xclass="form-element">
				<input type="text" name="to" id="to" value="" autocomplete="off" />
			  </div>
			</div>

			<div Xclass="form-wrapper" id="toValues-wrapper">
			  <div Xclass="form-element" id="toValues-element">
...
<?php endif; ?>
  ...
  <div style="width: 300px; float: left; padding: 10px; padding-left: 40px">
    <div style="padding-bottom: 12px">
      <strong style="color: #777"> <?php echo $this->translate('TOTAL POINTS EARNED') ?> </strong> <br>
    </div>
    
    <img style="float: left; margin-right: 8px" src="application/modules/Activitypoints/externals/images/userpoints_coins32.png">
    <div style="font-size: 24px; color: #777">
      <strong> <?php echo $this->user_points_totalearned ?> </strong> <?php echo $this->translate('coupons') ?>
    </div>
  </div>
...
<div style="padding-left: 10px; padding-top: 40px">
  ...
  <div style="width: 300px; float: left">
    <div style="padding-bottom: 12px">
      <strong style="color: #777"> <?php echo $this->translate('STAR RATING') ?> </strong> <br>
    </div>
    
    <img style="float: left; margin-right: 8px" src="application/modules/Activitypoints/externals/images/star-32x32.png">
    <div style="font-size: 24px">
      <?php if ($this->user_points_totalearned != 0): ?>
      <strong style="color: #777"> <?php echo $this->user_rank ?> </strong> <a href="<?php echo $this->url(array(), 'topusers') ?>"> <?php echo $this->translate('place') ?> </a>
      <?php else: ?>
