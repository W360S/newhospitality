...
class Activitypoints_Widget_UserhomePointsController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $this->view->userpoints_enable_offers = Engine_Api::_()->getDbTable('modules','core')->hasModule('activityrewards') && (Semods_Utils::getSetting('activityrewards.enable_offers',0) == 1);
    $this->view->userpoints_enable_shop = Engine_Api::_()->getDbTable('modules','core')->hasModule('activityrewards') && (Semods_Utils::getSetting('activityrewards.enable_shop',0) == 1);
