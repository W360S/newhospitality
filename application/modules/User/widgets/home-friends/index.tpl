...
<div>' + list_name + '</div>',
    ...
    en4.core.runonce.add(function() {
        $$('.profile_friends_lists input').each(function(element) {
...
<?php //print_r($this->totalItemCount); die; ?>
<ul class='profile_friends' id="user_profile_friends">
    ...
    <?php if (Engine_Api::_()->getApi('settings', 'core')->getSetting('user.friends.lists')): // BEGIN LIST CODE  ?>
                                ...
                                <div class="pulldown_contents">
                                    <ul>
                                        ...
                                        foreach ($this->lists as $list):
                                            ...
                                            <?php endforeach; ?>
                                        <li>
                                            <input type="text" title="<?php echo $this->translate('New list...') ?>" onclick="new Event(event).stop();" onkeypress="if (new Event(event).key == 'enter') {
                                          createFriendList(event, $(this), '<?php echo $member->user_id ?>');
                                      }" />
                                        </li>
                                    </ul>
                                </div>
