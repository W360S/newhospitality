...
class Activity_Model_DbTable_Actions extends Engine_Db_Table
{
  ...
  public function getAction($action_type, Core_Model_Item_Abstract $subject, Core_Model_Item_Abstract $object){
  ...
  public function addActivityBindings($action)
  {
    ...
    foreach( (array) $event->getResponses() as $response )
    {
      ...
      if ($response['type'] == 'registered' && $response['identity'] == "0") {
        # code...
        if ($count_registerd == 0) {
          # code...
