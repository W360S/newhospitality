...
.pt-how-story a.pt-link-03 {
    background: url("../img/front/icon-10.png") no-repeat scroll 0 3px rgba(0, 0, 0, 0);
}
.pt-how-story a.pt-link-04 {
    background: url("../img/front/icon-11.png") no-repeat scroll 0 3px rgba(0, 0, 0, 0);
}
.pt-how-story a.pt-link-05 {
    background: url("../img/front/icon-12.png") no-repeat scroll 0 3px rgba(0, 0, 0, 0);
}
.pt-how-story a.pt-link-06 {
    background: url("../img/front/icon-13.png") no-repeat scroll 0 3px rgba(0, 0, 0, 0);
}
.pt-block {
...
<div class="pt-block">
    ...
    <div class="pt-how-story">
    	<a href="<?php echo $this->baseUrl().PATH_SERVER_INDEX.'/resumes/resume/manage'?>" class="pt-link-03"><?php echo $this->translate("My Resume");?></a>
		<a href="<?php echo $this->baseUrl().PATH_SERVER_INDEX.'/recruiter/job/manage-apply' ?>" class="pt-link-04"><?php echo $this->translate('Applied Jobs ')?><span><?php echo $this->applyjob ?></span></a>
		<a href="<?php echo $this->baseUrl().PATH_SERVER_INDEX.'/recruiter/job/save-job'?>" class="pt-link-05"><?php echo $this->translate('Saved Jobs ')?><span class="no"><?php echo $this->savejob ?></span></a>
