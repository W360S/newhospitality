...
<div id="breadcrumb">
    <div class="section">
        <a href="<?php echo $this->baseUrl();?>"><?php echo $this->translate("Home");?></a> <span>&gt;</span> <a href="<?php echo $this->baseUrl().'/recruiter'?>"><?php echo $this->translate("Recruiter");?></a><span>&gt;</span> <strong><?php echo $job->position;?> <?php echo $this->translate(" - Candidates");?></strong>
    </div>
</div>
                    ...
                    $i=0;
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                    if($paginator->resume_id)
                                        echo $this->countExperience($paginator->resume_id)." years";?>
                                </td>
                                ...
                                |
                                <a href="javascript:void(0);" onclick="delete_candidate('<?php echo $paginator->applyjob_id ?>', '<?php echo $paginator->job_id ?>')"><?php echo $this->translate('Delete');?></a>
...
function delete_candidate(applyjob_id, job_id){
    var url="<?php echo $this->baseUrl().'/recruiter/job/delete-apply-job'?>";
    if(confirm("Do you really want to delete this candidate?")){
        ...
        onSuccess : function(responseHTML)
        {
            ...
            if(responseHTML==1){
                ...
                window.location.href= "<?php echo $this->baseUrl().'/recruiter/job/view-candidate/job_id/'?>"+ job_id;
            }
