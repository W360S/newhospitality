...
<div id="content">
     <div class="section jobs">
        ...
        <div class="layout_middle">
            <div id="breadcrumb">
                <div class="section">
                    <a href="<?php echo $this->baseUrl();?>"><?php echo $this->translate("Home");?></a> <span>&gt;</span> <a href="<?php echo $this->baseUrl().'/resumes'?>"><?php echo $this->translate("Job Seekers");?></a> <span>&gt;</span> <strong><?php echo $this->industry($industry_id)->name;?></strong>
                </div>
            </div>
