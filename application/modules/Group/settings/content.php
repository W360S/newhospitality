...
return array(
    ...
    array(
        ...
        'description' => 'Displays Featured Group',
        'category' => 'Group',
        'type' => 'widget',
        'name' => 'group.featured'
    ),
    ...
    array(
        'title' => 'Profile Featured Group',
        'description' => 'Displays featured in profile group',
        'category' => 'Group',
        'type' => 'widget',
        'name' => 'group.profile-featured'
    ),
    array(
        'title' => 'Recent Groups',
        'description' => 'Displays Recently Add Groups',
        'category' => 'Group',
        'type' => 'widget',
        'name' => 'group.recent-groups'
    ),
    array(
        'title' => 'Recent Groups Activity',
        'description' => 'Displays Recent Activities of Groups',
        'category' => 'Group',
        'type' => 'widget',
        'name' => 'group.recent-groups-activity'
    ),
)
?>