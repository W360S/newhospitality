<form method="get" action="<?php echo $this->url(); ?>" enctype="application/x-www-form-urlencoded" id="search_form">
    ...
    <ul class="list_category pt-list-areas">
        <?php foreach ($this->data as $item): ?>
            <li ><a cat="<?php echo $item['category_id']; ?>" class="event_category <?php if ($this->category_id == $item['category_id']) {
            echo "category_selected";
        } ?>" href="javascript:void(0)"><?php echo $item['title']; ?><span><?php echo $item['cnt_group']; ?></span></a></li>
<?php endforeach; ?>
    </ul>
