												...
												<li>
													<div class="wd-adap-select">
														...
														<select name="order" id="order">
															<option  <?php if($order == 'creation_date DESC') echo "selected='selected'"; ?>  label="<?php echo $this->translate("Recently Created"); ?>" value="creation_date DESC"><?php echo $this->translate("Recently Created"); ?></option>
                <option  <?php if($order == 'member_count DESC') echo "selected='selected'"; ?> label="<?php echo $this->translate("Most Popular"); ?>" value="member_count DESC"><?php echo $this->translate("Most Popular"); ?></option>
														</select>
													</div>
												</li>
												<li>
													<div class="wd-adap-select">
														...
														<select name="view" id="view">
															<option <?php if($view == '') echo "selected='selected'"; ?> label="<?php echo $this->translate("Everyone's Groups"); ?>" value=""><?php echo $this->translate("Everyone's Groups"); ?></option>
                <option <?php if($view == 1) echo "selected='selected'"; ?> label="<?php echo $this->translate("Only My Friends' Groups"); ?>" value="1"><?php echo $this->translate("Only My Friends' Groups"); ?></option>
														</select>
													</div>
