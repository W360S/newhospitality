    ...
    en4.core.runonce.add(function() {
        ...
        $('group_members_search_input').addEvent('keypress', function(e) {
            ...
            en4.core.request.send(new Request.HTML({
                ...
                'element': $('group_profile_members_anchor').getParent().getParent()
            });
        });
    });
...
<?php if (!$this->waiting): ?>
    <div class="group_members_info">
        <div class="group_members_search">
            <input id="group_members_search_input" type="text" value="<?php echo $this->translate('Search Members') ?>" onfocus="$(this).store('over', this.value);
...
<?php if ($this->members->getTotalItemCount() > 0): ?>
    ...
    <ul class='group_members'>
        <?php foreach ($this->members as $member): ?>
            ...
            ?>
            <li id="group_member_<?php echo $member->getIdentity() ?>" <?php if ($i %2 != 0) echo 'class="pt-odd"' ?>>
                <?php $i++; ?>
