...
<script type="text/javascript">
 ...
 jQuery("#widget_searchs").show();
	...
	var default_key_word = "Nhập từ khóa";
	...
	<div class="pt-content-searching">
			<form method="post" accept-charset="utf-8">
				<fieldset>
					<ul>
						<li>
							<input type="text" name="name" id="search_keyword" type="text" onblur="if(this.value=='') this.value='Nhập từ khóa'"
								onfocus="if(this.value=='Nhập từ khóa') this.value='';" 
								value="<?php echo 'Nhập từ khóa'; ?>"
