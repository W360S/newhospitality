						...
						<div class="pt-content-questions">
								...
								<div class="pt-content-questions-content">
									<div class="pt-like-how">
										<?php 
											//$arr_like_username = explode("&&",$data->like_username);
											$arr_like_displayname = explode("&&",$data->like_name);
											$str ="";
										...
										<span title="<?php echo $str; ?>" id="question-number-like"  class="pt-number-like"><?php echo $data->cnt_like ?></span>
									</div>
