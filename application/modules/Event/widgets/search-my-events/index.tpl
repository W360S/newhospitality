											...
											<ul>
												...
												<li>
													<div class="wd-adap-select">
            											...
            											<?php $view = Zend_Controller_Front::getInstance()->getRequest()->view; ?>
														<select name="view" id="view" >
											                <option <?php if($view == 'everyone') echo "selected='selected'"; ?>  value="everyone" label="<?php echo $this->translate("All My Events"); ?>"><?php echo $this->translate("All My Events"); ?></option>
											                <option <?php if($view == 2) echo "selected='selected'"; ?>  value="2" label="<?php echo $this->translate("Only Events I Lead"); ?>"><?php echo $this->translate("Only Events I Lead"); ?></option>
											            </select>
