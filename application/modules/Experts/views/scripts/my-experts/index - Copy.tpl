<style type="text/css">
.list_my_questions{padding-left: 1px;}
</style>
    ...
    <div class="layout_middle">
        <div class="headline">
			<div class="breadcrumb_expert">
				<h2><a class="first" href="<?php echo $this->url(array('module'=>'experts','controller'=>'index','action'=>'index'),'default', true); ?>">experts</a> <a href="<?php echo $this->baseUrl("/")."experts/my-experts/"; ?>"><?php echo $this->translate('Expert tool'); ?></a></h2>
			</div>
			<div class="clear"></div>
        </div>
			...
			<div class="list_my_questions">
                ...
                <table cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr class="<?php if($cnt%2 != 0) echo "background_gray"; ?>">
						...
						<td style="width:300px"><a class="title" href="<?php echo $this->url(array('module'=>'experts','controller'=>'my-experts','action'=>'detail','question_id'=>$item->question_id),'default', false); ?>"><?php echo $item->title ; ?></a></td>
						<td style="width:300px"><?php echo $item->category ; ?></td>
			    ...
			    <?php else: ?>
                 <table cellspacing="0" cellpadding="0" border="0">
					<tr class="container_func">
						<td colspan="2">
							<?php echo "No questions in this item."; ?>
						</td>
                    </tr>
                 </table>       
                <?php endif; ?>    
