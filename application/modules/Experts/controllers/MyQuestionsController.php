...
class Experts_MyQuestionsController extends Core_Controller_Action_Standard
{
  ...
  public function composeAction()
  {
    ...
    if ($this->_request->isPost())
    {
      ...
      if(!empty($title) && !empty($content) && (count($arr_exp) < 4) && (count($arr_exp) > 0) && $check_file){
              ...
              try {
                foreach($arr_exp as $item){
                   ...
                   $defaultParams = array(
                    ...
                    Engine_Api::_()->getApi('mail', 'core')->sendSystem($expert_data,
                    'expert_question', $defaultParams);
                }
