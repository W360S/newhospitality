...
<ul class="pt-reply-list">
	...
	<li>
		...
		for($i=1; $i<=count($arr_cat_name); $i++){
...
<div class="pt-paging">
	<?php echo $this->paginationControl($this->paginator, null, "application/modules/Experts/views/scripts/pagination-rating.tpl"); ?>
</div>
<?php endif; ?>
