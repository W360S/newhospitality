...
<div class="pt-how-story">
	...
	<a href="<?php echo $this->url(array('module'=>'experts','controller'=>'my-questions','action'=>'index'),'default',true); ?>" class="pt-link-02"><?php echo $this->translate('Câu hỏi của tôi'); ?><?php echo "(". intval($this->cnt_questions).")"; ?></a>
</div>