							...
							<div class="pt-how-book-details">
								...
								<div class="pt-info-coupon">
									...
									<div>
										...
										<a class="pt-like-how" href="javascript:void(0);"  onclick="javascript:ajaxLike(<?php echo $book->book_id; ?>,<?php echo $book->cnt_like; ?>)"></a>
										<span style="border:0px;" id="like_book" class="like_book"><?php echo $book->cnt_like; ?></span>
