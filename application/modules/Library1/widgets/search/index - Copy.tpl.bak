...
<div class="subcontent">
	<fieldset class="filter">
		...
		<div class="input select_sort">
            ...
            <label><?php echo $this->translate("Order by")?></label>
			...
			<input style="cursor:pointer;" id="search_book" class="button bt_expert" type="button" value="<?php echo $this->translate('Search')?>" />
		</div>
	</fieldset>
</div>
<script type="text/javascript">
