<h2><?php echo $this->translate("top downloads")?></h2>
            ...
            <?php endif; ?>
                <li>
                    ...
                    <div>
						...
						<p><?php  echo $this->translate(array(' %s download', ' %s downloads', intval($item->download_count)), intval($item->download_count)) ?></p>
					</div>
                </li>
            <?php endforeach; ?>
            </ul>
