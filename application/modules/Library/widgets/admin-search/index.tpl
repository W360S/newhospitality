...
<script type="text/javascript">
 ...
 window.addEvent('domready',function(){
    ...
    jQuery('#search_book').click(function() {
        jQuery("#widget_searchs").hide();
        var url = "<?php echo $this->baseUrl().'/admin/library/manage-libraries/index/'; ?>";
...
<div class="subcontent">
	<fieldset class="filter">
		...
		<div class="input select_sort">
			...
			<input id="search_book" class="button bt_expert" type="button" value="<?php echo $this->translate('Search'); ?>" />
		</div>
	</fieldset>
</div>
<script type="text/javascript">
