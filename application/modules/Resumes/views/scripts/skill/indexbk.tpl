...
<div class="resume_info_main subsection" style="border: medium none; margin-bottom: 35px;">
   ...
   <form id="resume_skill_form" action="<?php echo $form->getAction();?>" method="post" enctype="application/x-www-form-urlencoded">
    ...
    <div class="button_control">
		...
		<input id="save_skill" type="button" value="<?php echo $this->translate('Add');?>" class="min submit_save" onclick="saveResumeSkill('save');" />
		<a style="color:#fff" href="<?php echo $this->baseUrl().PATH_SERVER_INDEX.'/resumes/reference/index/resume_id/'.$resume_id ?>" id="submit" onclick="saveResumeLanguage('next');"><?php echo $this->translate("Next");?></a>
	</div>"
	</div>
    </form>
    </div>
