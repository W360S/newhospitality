 ...
 * @license    http://www.socialengine.net/license/
 */
class Community_Widget_MenuMiniController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    if( $viewer->getIdentity() )
    {
      ...
      $this->view->notificationCountMsg = Engine_Api::_()->getDbtable('notifications', 'activity')->hasNotificationsMessage($viewer);
      $this->view->notificationCountFriend = Engine_Api::_()->getDbtable('notifications', 'activity')->hasNotificationsFriend($viewer);
    }
